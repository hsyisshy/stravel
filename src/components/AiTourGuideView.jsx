...
export default function AiTourGuideView({ group }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {error && (
        <div className="rounded-2xl border border-rose-200 bg-rose-50/95 p-3 text-xs font-medium text-rose-700">
          {error}
        </div>
      )}

      {/* Input / Photo Section */}
      <div className="traveler-glass-card space-y-3.5">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="traveler-accent-btn px-4 py-2 text-xs"
            >
